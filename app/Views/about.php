...
<div class="container">
  ...
  <div class="responsive-container-block big-container">
    ...
    <div class="responsive-container-block textContainer">
      ...
      An "About Us" page is an essential part of any website, as it introduces your brand, team, mission, and values to visitors. 
      </p>
    </div>
            ...
            <div class="responsive-container-block">
              <div class="left4">
                <div class="responsive-cell-block wk-ipadp-6 wk-tab-12 wk-mobile-12 wk-desk-6" id="i10mt-2">
                  <input class="input" id="ijowk-2" name="Title" placeholder="Title">
                </div>
                <div class="responsive-cell-block wk-desk-6 wk-ipadp-6 wk-tab-12 wk-mobile-12">
                  <input class="input" id="indfi-2" name="SubTitle" placeholder="SubTitle">
                </div>
                <div class="responsive-cell-block wk-desk-6 wk-ipadp-6 wk-tab-12 wk-mobile-12">
                  <input class="input" id="ipmgh-2" name="Link" placeholder="Link">
                </div>
              ...
              <div class="responsive-cell-block wk-tab-12 wk-mobile-12 wk-desk-12 wk-ipadp-12" id="i634i-2">
                <textarea class="textinput" id="i5vyy-2" placeholder="Description"></textarea>
              </div>
            </div>
